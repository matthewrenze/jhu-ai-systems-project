...
output_folder_path = root_folder_path + "\\Data\\Training\\Intro to Data for Data Science\\GPT-4"
...
print("Starting few-shot training set creation ...")
...
for key in scripts_map:
    ...
    print(f"Creating few-shot examples for {key[0]}-{key[1]} ...")
    ...
    print(f"Created few-shot examples for {key[0]}-{key[1]}.")

with open(output_file_path, "w", encoding="utf-8") as file:
    file.write(output)

# Provide a final status
print("Finished few-shot training set creation.")
